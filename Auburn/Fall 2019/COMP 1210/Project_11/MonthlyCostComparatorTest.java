...
public class MonthlyCostComparatorTest {
   ...
   * test for compare().
   ...
   @Test public void compare() {
      MonthlyCostComparator obj = new MonthlyCostComparator();
      ...
      WiFi myobj3 = new WiFi("name1", 2.0, 3.0, 3.0);
      WiFi myobj4 = new WiFi("name2", 1.0, 2.0, 3.0);
      Assert.assertEquals(-1, obj.compare(myobj3, myobj4));
      WiFi myobj5 = new WiFi("name1", 2.0, 3.0, 3.0);
      WiFi myobj6 = new WiFi("name2", 2.0, 3.0, 3.0);
