; Purpose : This program is for checking if the two strings are anagram or not.
; Author  : Haegang Yang
; Date    : November 19, 2020
 includelib C:\Irvine32b\Irvine32.lib
 includelib C:\Irvine32\Kernel32.Lib
 includelib C:\Irvine32\User32.Lib
